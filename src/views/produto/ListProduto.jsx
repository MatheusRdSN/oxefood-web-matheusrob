        ...
        await axios.delete('http://localhost:8080/api/produto/' + idRemover)
            ...
            .catch((error) => {
                if (error.response?.data?.errors) {
                    ...
                    notifyError(error.response.data?.message || "Erro ao remover produto.");
                }
            });
                                ...
                                {lista.map(produto => (
                                    <Table.Row key={produto.id}>
                                        ...
                                        <Table.Cell textAlign='center'>
                                            ...
                                            &nbsp;
                                            <Button inverted circular color='red' icon onClick={() => setOpenModal(true) && setIdRemover(produto.id)}>
                                                <Icon name='trash' />
                                            </Button>
                                        </Table.Cell>
                                    </Table.Row>
